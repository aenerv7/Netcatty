...
const en: Messages = {
  ...
  // Sync panel — config form
  'sync.config.endpointUrl': 'Endpoint URL',
  'sync.config.endpointPlaceholder': 'https://dav.example.com/remote.php/dav/files/user',
  'sync.config.authType': 'Auth Type',
  'sync.config.authBasic': 'Basic',
  'sync.config.authDigest': 'Digest',
  'sync.config.authToken': 'Token (Bearer)',
  'sync.config.username': 'Username',
  'sync.config.password': 'Password',
  'sync.config.token': 'Token',
  'sync.config.encryptionPassword': 'Encryption Password',
  'sync.config.encryptionPlaceholder': 'Used to encrypt your data',
  'sync.config.connect': 'Connect',

  // Sync panel — connected view
  'sync.action.push': 'Push',
  'sync.action.pull': 'Pull',
  'sync.action.disconnect': 'Disconnect',

  // Sync panel — toast messages
  'sync.toast.connectedPulled': 'Connected and pulled remote data',
  'sync.toast.connectedPushed': 'Connected and pushed local data',
  'sync.toast.connectionFailed': 'Connection failed',
  'sync.toast.pushed': 'Pushed to remote',
  'sync.toast.pushFailed': 'Push failed',
  'sync.toast.pulled': 'Pulled from remote',
  'sync.toast.pullFailed': 'Pull failed',
  'sync.toast.disconnected': 'Disconnected from cloud sync',
  'time.never': 'Never',
  ...
  'terminal.sidePanel.scripts': 'Scripts',
  'terminal.sidePanel.aiChat': 'AI Chat',
  'terminal.sidePanel.movePanelToRight': 'Move panel to right',
  'terminal.sidePanel.movePanelToLeft': 'Move panel to left',
  'terminal.sidePanel.closePanel': 'Close panel',
