...
const zhCN: Messages = {
  ...
  'sync.config.endpointUrl': '服务器地址',
  'sync.config.endpointPlaceholder': 'https://dav.example.com/remote.php/dav/files/user',
  'sync.config.authType': '认证方式',
  'sync.config.authBasic': '基本认证',
  'sync.config.authDigest': '摘要认证',
  'sync.config.authToken': '令牌 (Bearer)',
  'sync.config.username': '用户名',
  'sync.config.password': '密码',
  'sync.config.token': '令牌',
  'sync.config.encryptionPassword': '加密密码',
  'sync.config.encryptionPlaceholder': '用于加密同步数据',
  'sync.config.connect': '连接',
  ...
  'sync.toast.connectedPulled': '已连接并拉取远端数据',
  'sync.toast.connectedPushed': '已连接并推送本地数据',
  'sync.toast.connectionFailed': '连接失败',
  'sync.toast.pushed': '已推送到远端',
  'sync.toast.pushFailed': '推送失败',
  'sync.toast.pulled': '已从远端拉取',
  'sync.toast.pullFailed': '拉取失败',
  'sync.toast.disconnected': '已断开云同步',
  'time.never': '从未',
  'time.justNow': '刚刚',
  ...
  'terminal.sidePanel.scripts': '脚本',
  'terminal.sidePanel.aiChat': 'AI 聊天',
  'terminal.sidePanel.movePanelToRight': '将面板移到右侧',
  'terminal.sidePanel.movePanelToLeft': '将面板移到左侧',
  'terminal.sidePanel.closePanel': '关闭面板',
