...
interface UseSftpViewPaneActionsResult {
  ...
  onCreateDirectoryLeft: (name: string) => Promise<void>;
  onCreateDirectoryRight: (name: string) => Promise<void>;
  onCreateDirectoryAtPathLeft: (path: string, name: string) => Promise<void>;
  onCreateDirectoryAtPathRight: (path: string, name: string) => Promise<void>;
  onCreateFileLeft: (name: string) => Promise<void>;
  onCreateFileRight: (name: string) => Promise<void>;
  onCreateFileAtPathLeft: (path: string, name: string) => Promise<void>;
  onCreateFileAtPathRight: (path: string, name: string) => Promise<void>;
  onDeleteFilesLeft: (names: string[]) => Promise<void>;
  onDeleteFilesRight: (names: string[]) => Promise<void>;
  onDeleteFilesAtPathLeft: (connectionId: string, path: string, names: string[]) => Promise<void>;
  onDeleteFilesAtPathRight: (connectionId: string, path: string, names: string[]) => Promise<void>;
  onRenameFileLeft: (old: string, newName: string) => Promise<void>;
  onRenameFileRight: (old: string, newName: string) => Promise<void>;
  onRenameFileAtPathLeft: (oldPath: string, newName: string) => Promise<void>;
  onRenameFileAtPathRight: (oldPath: string, newName: string) => Promise<void>;
  onMoveEntriesToPathLeft: (sourcePaths: string[], targetPath: string) => Promise<void>;
  onMoveEntriesToPathRight: (sourcePaths: string[], targetPath: string) => Promise<void>;
