import { Circle, Columns2, MessageSquare, PanelLeft, PanelRight, Plus, Search, Server, X, Zap } from 'lucide-react';
                ...
                <div
                  ...
                  >
                    <Tooltip>
                      ...
                      <TooltipContent>{t('terminal.sidePanel.scripts')}</TooltipContent>
                    </Tooltip>
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <Button
                      ...
                      <TooltipContent>{t('terminal.sidePanel.aiChat')}</TooltipContent>
                    </Tooltip>
                    {isSidePanelOpenForCurrentTab && (
                    <>
                    ...
                    <Tooltip>
                      ...
                      <TooltipContent>
                        {sidePanelPosition === 'left' ? t('terminal.sidePanel.movePanelToRight') : t('terminal.sidePanel.movePanelToLeft')}
                      </TooltipContent>
                    </Tooltip>
                    <Tooltip>
                      <TooltipTrigger asChild>
                      ...
                      <TooltipContent>{t('terminal.sidePanel.closePanel')}</TooltipContent>
                    </Tooltip>
                    </>
                    )}
                  </div>
